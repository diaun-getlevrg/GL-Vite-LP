...
import { ArrowRight, Zap, BarChart3, TrendingUp, Quote, Lock, Mail, Shield, BookOpen } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-consulting-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
/* ════════════════════════════════════════════════════════════════════════════
   EXPORT: WebsiteOptimizationConsultingPage
   ════════════════════════════════════════════════════════════════════════════ */

export function WebsiteOptimizationConsultingPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Build a credibility-first website for your consulting firm. Case studies, methodology pages, and thought leadership that converts prospects before the first call.",
