...
import { ArrowRight, Zap, BarChart3, TrendingUp, Quote, Lock, Mail, Shield, Users } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-agencies-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
/* ════════════════════════════════════════════════════════════════════════════
   EXPORT: WebsiteOptimizationAgenciesPage
   ════════════════════════════════════════════════════════════════════════════ */

export function WebsiteOptimizationAgenciesPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Give your agency website the polish you deliver to clients. Portfolio showcases, conversion-optimized service pages, and a design that builds instant credibility.",
