...
import { ArrowRight, Zap, BarChart3, TrendingUp, Quote, Lock, Mail, Shield, Scale } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-legal-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
/* ════════════════════════════════════════════════════════════════════════════
   EXPORT: WebsiteOptimizationLegalPage
   ════════════════════════════════════════════════════════════════════════════ */

export function WebsiteOptimizationLegalPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Turn law firm website visitors into booked consultations. Clear practice area pages, compelling attorney profiles, and frictionless contact flows launch in 30 days.",
