        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-saas-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function SocialSaaSPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Consistent social presence for B2B SaaS companies. Dedicated social media team turning product updates, case studies, and insights into a consistent content engine.",
