        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-it-services-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function SocialITServicesPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Build thought leadership in your IT niche. Dedicated social media team for IT companies cybersecurity insights, tech tips, and company updates that generate inbound leads.",
