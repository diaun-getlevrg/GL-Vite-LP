        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-accounting-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function SocialAccountingPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Dedicated social media team for accounting and CPA firms. 12–20 posts monthly across LinkedIn, Facebook, and Instagram. No partner time required. Live in 14 days.",
