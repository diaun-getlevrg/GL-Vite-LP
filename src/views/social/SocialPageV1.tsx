...
import { ArrowRight, Clock, Star, Play, Pause, Smartphone, Briefcase } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 lg:h-full flex flex-col">
        ...
        >
          Get a dedicated social media team to handle strategy, copy, design, scheduling, and reporting
          <br />
          across LinkedIn, Instagram, and Facebook. You focus on the business. We keep it consistent.
        </motion.p>
