        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-architecture-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function SocialArchitecturePage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Showcase your portfolio where clients are looking. Dedicated social media team for architecture firms project stories, design philosophy, and thought leadership.",
