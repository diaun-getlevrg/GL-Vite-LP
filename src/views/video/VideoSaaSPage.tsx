...
import { ArrowRight, Zap, TrendingUp, Shield, Star, CalendarDays, Lock, Mail, Code, Film, Video, Sparkles, Palette } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro animation={<VideoAnimation config={{
            ...
            <div className="rounded-2xl border border-gray-200 bg-white/95 backdrop-blur-xl shadow-2xl p-6 sm:p-8">
              ...
              <form id="video-saas-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
/* ════════════════════════════════════════════════════════════════════════════
   EXPORT: VideoSaaSPage
   ════════════════════════════════════════════════════════════════════════════ */

export function VideoSaaSPage() {
  return (
    <PageShell
      navItems={[
