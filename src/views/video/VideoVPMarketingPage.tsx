...
import { ArrowRight, Zap, TrendingUp, Shield, Star, CalendarDays, Lock, Mail, BarChart2, Film, Video, Sparkles, Palette } from "lucide-react";
...
export function VideoVPMarketingPage() {
  return (
    <PageShell
      navItems={[
