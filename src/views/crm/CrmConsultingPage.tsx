        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <div className="flex items-center gap-3 pl-8">
                <div className="w-9 h-9 rounded-full bg-spark-100 flex items-center justify-center">
                  <span className="text-xs font-bold text-spark-700">DO</span>
                </div>
                <div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              <div className="mb-6">
                <h3 className="text-sub font-bold text-gray-900 mb-1.5">Claim Free CRM Audit</h3>
...
/* ════════════════════════════════════════════════════════════════════════════
   EXPORT: CrmConsultingPage
   ════════════════════════════════════════════════════════════════════════════ */

export function CrmConsultingPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Build real-time CRM dashboards for your consulting firm — project pipeline, revenue forecasts, utilization rates, and client health scores that update automatically.",
