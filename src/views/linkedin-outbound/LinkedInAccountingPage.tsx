        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-accounting-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function LinkedInAccountingPage() {
  return (
    <PageShell
      navItems={[
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "LinkedIn Pipeline Generation for Accounting Firms | Get Levrg",
        description: "Build a higher-value client base through targeted LinkedIn outreach. Reach decision-makers who need accounting, audit, and tax expertise — qualified meetings in 14 days.",
        keywords: "LinkedIn outbound for accounting firms, CPA firm lead generation, accounting firm LinkedIn outreach",
        ogTitle: "LinkedIn Pipeline Generation for Accounting Firms | Get Levrg",
