        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-consulting-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function LinkedInConsultingPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Turn consulting expertise into inbound conversations. We combine thought leadership content with targeted LinkedIn outreach to position your firm as the go-to authority.",
