        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-architecture-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function LinkedInArchitecturePage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Win more projects through targeted LinkedIn outreach to developers, property owners, and facilities managers. Get in front of opportunities before they go to bid.",
