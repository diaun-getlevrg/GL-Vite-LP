        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-legal-hero-form" ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
...
export function LinkedInLegalPage() {
  return (
    <PageShell
      navItems={[
      ...
      meta={{
        ...
        description: "Build consistent deal flow for your law firm through managed LinkedIn outreach. Qualified consultations across corporate, litigation, and regulatory practice areas.",
